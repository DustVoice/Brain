---
{"publish":true,"created":"2025-05-02 13:33","tags":["OS/Fedora"],"cssclasses":""}
---
...
Create and initially populate the `vaultwarden.env` file under the [[Vaultwarden#Data directories\|previously created directory]] `~/containers/vaultwarden`
