...
> [!attention]
> You **need** to perform the [[#Windows| > Windows]] installation in addition to the distro's specific instructions.

## Windows

First, you need to install the [usbipd-win](https://github.com/dorssel/usbipd-win) software on the Windows side.
Some [[#GUI| > GUI]] tools automatically install this.
